            ...
            <div className='container'>
                <div className='row'>
                    <div className='d-flex justify-content-between mt-5 pb-3'>
                        <h4 className='h4 pb-0 mb-0'>Marcas</h4>
                        <Link to="/admin/brands/create" className="btn btn-primary">Crear</Link>
                    </div>
                    ...
                    <div className='col-md-9'>
                        <div className='card shadow'>
                            <div className='card-body p-4'>
                                ...
                                {
                                    loader == false && brands.length == 0 && <NoState text="No se encontraron marcas..." />
                                }
                                {
                                                ...
                                                brands.map(brand => {
                                                    return (
                                                        <tr key={`brand-${brand.id}`}>
                                                            ...
                                                            <td>
                                                                {
                                                                    brand.status == 1 ? <span className='badge text-bg-success'>Activo</span>
                                                            ...
                                                            <td>
                                                                ...
                                                                <Link className='text-danger ms-3' onClick={() => deletebrand(brand.id)}>
