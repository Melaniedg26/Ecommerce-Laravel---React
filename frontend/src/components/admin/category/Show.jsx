            ...
            <div className='container'>
                <div className='row'>
                    <div className='d-flex justify-content-between mt-5 pb-3'>
                        <h4 className='h4 pb-0 mb-0'>Categorias</h4>
                        <Link to="/admin/categories/create" className="btn btn-primary">Crear</Link>
                    ...
                    <div className='col-md-9'>
                        <div className='card shadow'>
                            <div className='card-body p-4'>
                                ...
                                {
                                    loader == false && categories.length == 0 && <NoState text="No se encontraron categorias..." />
                                }
                                {
                                                ...
                                                categories.map(category => {
                                                    return (
                                                        <tr key={`category-${category.id}`}>
                                                            ...
                                                            <td>
                                                                {
                                                                    category.status == 1 ? <span className='badge text-bg-success'>Activo</span>
                                                            ...
                                                            <td>
                                                                ...
                                                                <Link className='text-danger ms-3' onClick={() => deleteCategory(category.id)}>
