            ...
            <div className='container'>
                <div className='row'>
                    <div className='d-flex justify-content-between mt-5 pb-3'>
                        <h4 className='h4 pb-0 mb-0'>Productos</h4>
                        <Link to="/admin/products/create" className="btn btn-primary">Crear</Link>
                    </div>
                    ...
                    <div className='col-md-9'>
                        <div className='card shadow'>
                            <div className='card-body p-4'>
                                ...
                                {
                                    loader == false && products.length == 0 && <NoState text="No se encontraron productos..." />
                                }
                                {
                                                ...
                                                products.map(product => {
                                                    return (
                                                        <tr key={`product-${product.id}`}>
                                                            ...
                                                            <td>
                                                                {
                                                                    product.status == 1 ? <span className='badge text-bg-success'>Activo</span>
                                                            ...
                                                            <td>
                                                                ...
                                                                <Link className='text-danger ms-3' onClick={() => deleteProduct(product.id)}>
