...
const Cart = () => {
    const { cartData, total, subTotal, shipping, updatedCartItem, deleteCartItem } = useContext(CartContext);
        ...
        <Layout>
            <div className='container pb-5'>
                <div className='row'>
                    ...
                    <div className='col-md-12'>
                        <h2 className='border-bottom pb-3'>Carrito</h2>
                            ...
                            <tbody>
                                {
                                    cartData.length == 0 &&
                                    <tr>
                                        <td align='center' valign='middle' colSpan={4} style={{ height: 200 }}>Tu carrito esta vacio...</td>
                                    </tr>
                                }
                                {
